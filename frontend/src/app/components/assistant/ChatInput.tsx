...
import type { ReasoningLevel } from "./ModelToggle";
...
export const ChatInput = forwardRef<ChatInputHandle, Props>(function ChatInput(
    ...
    // the submit key check fail open instead of
    ...
    const [reasoningLevel] = useSelectedReasoning({
        selectionKey: chatKey,
        chatReasoningLevel,
    ...
    return (
        <>
            ...
            <WarningPopup
                ...
                message="No AI service is available. Check your connection settings and try again."
            />
            <UploadOverlay
